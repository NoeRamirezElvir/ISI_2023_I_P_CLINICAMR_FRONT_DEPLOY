...
var encabezados = [
    ["Reporte de Costo Historico Medicamento"],
...
var docDefinition = {
    ...
    { text: 'Reporte de Costo Historico Medicamento', style: 'header', alignment: 'center' },
    { text: '\n' },
    ...
    { text: '\n' },
    {
        ...
        body: [
            ...
            { text: 'Costo', style: 'tableHeader', fillColor: '#C6C6C6' },
            ...
            return [
                ...
                { text: dato.costo, fillColor: index % 2 === 0 ? '#E5E5E5' : '#D9D9D9',style:'name' },
