  ...
  document.getElementById("exportarBtn").addEventListener("click", function() {
    ...
    var datosManipulados = listaDatos.map(function(dato) {
      return {
        ...
        TipoExamen: dato.idMedicamento.nombre,
        TipoExamen: dato.idMedicamento.cantidad
      };
    });
    ...
    var encabezados = [
      ["Reporte de Recaudo Detalle Medicamento"],
  ...
  document.getElementById("exportBtn").addEventListener("click", function() {
    ...
    var docDefinition = {
      content: [
        ...
        { text: 'Reporte de Recaudo Detalle Medicamento', style: 'header', alignment: 'center' },
        { text: '\n' },
          ...
          table: {
            ...
            body: [
              [
                ...
                { text: 'Cantidad', style: 'tableHeader', fillColor: '#C6C6C6' }
              ],
              ...datos.map(function(dato, index) {
                return [
                  ...
                  { text: dato.idMedicamento.cantidad, fillColor: index % 2 === 0 ? '#E5E5E5' : '#D9D9D9',style:'name' }
                ];
              })
            ]
          }
