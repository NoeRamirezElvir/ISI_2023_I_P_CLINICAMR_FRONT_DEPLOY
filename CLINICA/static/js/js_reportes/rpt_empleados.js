  ...
  document.getElementById("exportBtn").addEventListener("click", function() {
    ...
    var docDefinition = {
      content: [
        ...
        { text: 'Reporte de Empleados', style: 'header', alignment: 'center' },
        { text: '\n' },
            ...
            body: [
              ...
              ...datos.map(function(dato, index) {
                return [
                  ...
                  { text: dato.nombre + " " + dato.apellidos, fillColor: index % 2 === 0 ? '#E5E5E5' : '#D9D9D9',style:'name' },
                  ...
                  { text: dato.email, fillColor: index % 2 === 0 ? '#E5E5E5' : '#D9D9D9',style:'name' },
