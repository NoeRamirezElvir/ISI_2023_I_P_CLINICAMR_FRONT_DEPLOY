...
function corregirDatosHidden() {
  ...
  document.getElementById("exportarBtn").addEventListener("click", function() {
    ...
    var datosManipulados = listaDatos.map(function(dato) {
      return {
        ID: dato.id,
        Descripción: dato.idDiagnostico.descripcion,
        Enfermedad: dato.idEnfermedad.nombre
      };
    });
    ...
    var encabezados = [
      ["Reporte de Detalles de Diagnostico"],
  ...
  document.getElementById("exportBtn").addEventListener("click", function() {
    ...
    var docDefinition = {
      content: [
        ...
        { text: 'Reporte de Detalles de Diagnostico', style: 'header', alignment: 'center' },
        { text: '\n' },
            ...
            body: [
              ...
              ...datos.map(function(dato, index) {
                return [
                  ...
                  { text: dato.idDiagnostico.descripcion, fillColor: index % 2 === 0 ? '#E5E5E5' : '#D9D9D9',style:'name' },
                  { text: dato.idEnfermedad.nombre, fillColor: index % 2 === 0 ? '#E5E5E5' : '#D9D9D9',style:'name' }
                ];
              })
            ]
          }
