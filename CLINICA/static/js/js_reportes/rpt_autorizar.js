  ...
  document.getElementById("exportBtn").addEventListener("click", function() {
    ...
    var docDefinition = {
      content: [
        ...
        { text: 'Reporte de Autorizaciones', style: 'header', alignment: 'center' },
        { text: '\n' },
          ...
          table: {
            ...
            body: [
              [
                ...
                { text: 'Confirmación', style: 'tableHeader', fillColor: '#C6C6C6' },
              ],
              ...datos.map(function(dato, index) {
                return [
                  { text: dato.id, fillColor: index % 2 === 0 ? '#E5E5E5' : '#D9D9D9' ,style:'name'},
                  { text: dato.motivos, fillColor: index % 2 === 0 ? '#E5E5E5' : '#D9D9D9' ,style:'name'},
                  { text: dato.confirmacion === 1 ? 'Activo' : 'Inactivo', fillColor: index % 2 === 0 ? '#E5E5E5' : '#D9D9D9' ,style:'name'},
                ];
              })
            ]
          }
