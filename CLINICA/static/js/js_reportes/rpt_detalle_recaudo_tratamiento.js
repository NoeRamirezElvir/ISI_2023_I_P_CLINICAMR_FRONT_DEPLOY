  ...
  document.getElementById("exportarBtn").addEventListener("click", function() {
    ...
    var datosManipulados = listaDatos.map(function(dato) {
      return {
        ...
        TipoExamen: dato.idTratamiento.tipo.nombre
      };
    });
    ...
    var encabezados = [
      ["Reporte de Recaudo Detalle Tratamiento"],
  ...
  document.getElementById("exportBtn").addEventListener("click", function() {
    ...
    var docDefinition = {
      content: [
        ...
        { text: 'Reporte de Recaudo Detalle Tratamiento', style: 'header', alignment: 'center' },
        { text: '\n' },
          ...
          table: {
            ...
            body: [
              [
                ...
                { text: 'Tipo de Tratamiento', style: 'tableHeader', fillColor: '#C6C6C6' }
              ],
              ...datos.map(function(dato, index) {
                return [
                  ...
                  { text: dato.idTratamiento.tipo.nombre, fillColor: index % 2 === 0 ? '#E5E5E5' : '#D9D9D9',style:'name' }
                ];
              })
            ]
          }
