...
document.getElementById("exportBtn").addEventListener("click", function() {
  ...
  var docDefinition = {
    content: [
      ...
      { text: '\n' },
      {
        table: {
          headerRows: 1,
          widths: [15, 75, 75, 75, 75, 75, 75],
          body: [
            ['ID', 'Nombre', 'Apellido', 'Fecha de Nacimiento', 'Teléfono', 'Correo', 'Dirección'],
  ...
  pdfMake.createPdf(docDefinition).download("reporte_pacientes.pdf");
});
