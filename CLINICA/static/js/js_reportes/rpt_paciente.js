...
document.getElementById("exportarBtn").addEventListener("click", function() {
  ...
  var nombreArchivo = "reporte_pacientes_" + fechaActual + ".xlsx";
...
document.getElementById("exportBtn").addEventListener("click", function() {
  ...
  var docDefinition = {
    content: [
      ...
      { text: 'Reporte de Pacientes', style: 'header', alignment: 'center' },
      { text: '\n' },
      ...
      { text: '\n' },
      {
        table: {
          headerRows: 1,
          widths: [15, 70, 90, 65, 60, 90, 90],
          body: [
            [
              { text: 'ID', style: 'tableHeader', fillColor: '#C6C6C6' },
              { text: 'Nombre', style: 'tableHeader', fillColor: '#C6C6C6' },
              { text: 'Documento', style: 'tableHeader', fillColor: '#C6C6C6' },
              { text: 'Fecha de Nacimiento', style: 'tableHeader', fillColor: '#C6C6C6' },
              { text: 'Teléfono', style: 'tableHeader', fillColor: '#C6C6C6' },
              { text: 'Correo', style: 'tableHeader', fillColor: '#C6C6C6' },
            ...
            ...datos.map(function(dato, index) {
              return [
                ...
                { text: dato.nombre + " " + dato.apellido, fillColor: index % 2 === 0 ? '#E5E5E5' : '#D9D9D9', style:'name'},
                { text: dato.documento, fillColor: index % 2 === 0 ? '#E5E5E5' : '#D9D9D9', style:'name'},
                { text: dato.fechaNacimiento, fillColor: index % 2 === 0 ? '#E5E5E5' : '#D9D9D9', style:'name'},
                { text: dato.telefono, fillColor: index % 2 === 0 ? '#E5E5E5' : '#D9D9D9', style:'name'},
                { text: dato.correo, fillColor: index % 2 === 0 ? '#E5E5E5' : '#D9D9D9', style:'name'},
