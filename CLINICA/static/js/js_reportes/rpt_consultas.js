...
function corregirDatosHidden() {
  ...
  document.getElementById("exportarBtn").addEventListener("click", function() {
    ...
    var datosManipulados = listaDatos.map(function(dato) {
      return {
        ID: dato.id,
        Paciente: dato.idCita.idPaciente.nombre + " / " + dato.idCita.idPaciente.documento,
        fechaRegistro: dato.fecha,
        fechaProgramada: dato.idCita.idPaciente.fechaProgramada,
        Tipo: dato.idTipo.nombre,
        Precio: dato.idTipo.precio
      };
    });
  ...
  document.getElementById("exportBtn").addEventListener("click", function() {
    ...
    var docDefinition = {
      content: [
        ...
        { text: 'Reporte de Consultas', style: 'header', alignment: 'center' },
        { text: '\n' },
            ...
            body: [
              ...
              ...datos.map(function(dato, index) {
                return [
                  ...
                  { text: dato.idCita.idPaciente.nombre + "/" + dato.idCita.idPaciente.documento, fillColor: index % 2 === 0 ? '#E5E5E5' : '#D9D9D9',style:'name' },
                  { text: dato.fecha, fillColor: index % 2 === 0 ? '#E5E5E5' : '#D9D9D9',style:'name' },
                  { text: dato.idCita.idPaciente.fechaProgramada, fillColor: index % 2 === 0 ? '#E5E5E5' : '#D9D9D9',style:'name' },
                  { text: dato.idTipo.nombre, fillColor: index % 2 === 0 ? '#E5E5E5' : '#D9D9D9',style:'name' },
                  { text: dato.idTipo.precio, fillColor: index % 2 === 0 ? '#E5E5E5' : '#D9D9D9',style:'name' }
                ];
              })
            ]
          }
