...
function corregirDatosHidden() {
  ...
  document.getElementById("exportarBtn").addEventListener("click", function() {
    ...
    var datosManipulados = listaDatos.map(function(dato) {
      return {
        ID: dato.id,
        Paciente: dato.idTratamiento.idPaciente.documento + "/" + dato.idTratamiento.idPaciente.nombre,
        Servicio: dato.idTratamiento.idTipo.nombre,
  ...
  document.getElementById("exportBtn").addEventListener("click", function() {
    ...
    var docDefinition = {
      content: [
        ...
        { text: 'Reporte de Resultados', style: 'header', alignment: 'center' },
        { text: '\n' },
            ...
            body: [
              ...
              ...datos.map(function(dato, index) {
                return [
                  ...
                  { text: dato.idTratamiento.idPaciente.documento + "/" + dato.idTratamiento.idPaciente.nombre, fillColor: index % 2 === 0 ? '#E5E5E5' : '#D9D9D9',style:'name' },
                  { text: dato.idTratamiento.idTipo.nombre, fillColor: index % 2 === 0 ? '#E5E5E5' : '#D9D9D9',style:'name' },
