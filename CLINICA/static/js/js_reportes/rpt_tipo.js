  ...
  document.getElementById("exportarBtn").addEventListener("click", function() {
    ...
    var datosManipulados = listaDatos.map(function(dato) {
      return {
        ID: dato.id,
        Nombre: dato.nombre,
        Subtipo: dato.idsubtipo.nombre,
        Precio: dato.precio === '0.00' ? "N/A":dato.precio,
        Impuesto: dato.idImpuesto.length === 0 ? "N/A":dato.idImpuesto.nombre
      };
    });
  ...
  document.getElementById("exportBtn").addEventListener("click", function() {
    ...
    var docDefinition = {
      content: [
        ...
        { text: 'Reporte de Tipos', style: 'header', alignment: 'center' },
        { text: '\n' },
          ...
          table: {
            ...
            body: [
              [
                ...
                { text: 'Subtipo', style: 'tableHeader', fillColor: '#C6C6C6' },
              ...
              ...datos.map(function(dato, index) {
                return [
                  ...
                  { text: dato.idsubtipo.nombre, fillColor: index % 2 === 0 ? '#E5E5E5' : '#D9D9D9',style:'name' },
                  { text: dato.precio === '0.00' ? 'N/A':dato.precio, fillColor: index % 2 === 0 ? '#E5E5E5' : '#D9D9D9',style:'name' },
                  { text: dato.idImpuesto.length === 0 ? 'N/A' : dato.idImpuesto.nombre, fillColor: index % 2 === 0 ? '#E5E5E5' : '#D9D9D9',style:'name' }
                ];
              })
            ]
          }
