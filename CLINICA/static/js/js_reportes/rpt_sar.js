  ...
  document.getElementById("exportarBtn").addEventListener("click", function() {
    ...
    var datosManipulados = listaDatos.map(function(dato) {
      return {
        ID: dato.id,
        CAI: dato.cai,
        RangoInicial: dato.rangoInicial,
        RangoFinal: dato.rangoFinal,
        Consecutivo: dato.consecutivo,
        FechaInicio: dato.fechaInicio,
        FechaFinal: dato.fechaLimiteEmision
      };
    });
  ...
  document.getElementById("exportBtn").addEventListener("click", function() {
    ...
    var docDefinition = {
      content: [
        ...
        { text: 'Reporte de Correlativo SAR', style: 'header', alignment: 'center' },
        { text: '\n' },
          ...
          table: {
            ...
            body: [
              [
                ...
                { text: 'Rango Inicial', style: 'tableHeader', fillColor: '#C6C6C6' },
                { text: 'Rango Final', style: 'tableHeader', fillColor: '#C6C6C6' },
                { text: 'Consecutivo', style: 'tableHeader', fillColor: '#C6C6C6' },
              ...
              ...datos.map(function(dato, index) {
                return [
                  ...
                  { text: dato.cai, fillColor: index % 2 === 0 ? '#E5E5E5' : '#D9D9D9',style:'name' },
                  { text: dato.rangoInicial, fillColor: index % 2 === 0 ? '#E5E5E5' : '#D9D9D9',style:'name' },
                  { text: dato.rangoFinal, fillColor: index % 2 === 0 ? '#E5E5E5' : '#D9D9D9',style:'name' },
                  { text: dato.consecutivo, fillColor: index % 2 === 0 ? '#E5E5E5' : '#D9D9D9',style:'name' },
                  { text: dato.fechaInicio, fillColor: index % 2 === 0 ? '#E5E5E5' : '#D9D9D9',style:'name' },
                  { text: dato.fechaLimiteEmision, fillColor: index % 2 === 0 ? '#E5E5E5' : '#D9D9D9',style:'name' }
                ];
              })
            ]
          }
