  ...
  document.getElementById("exportBtn").addEventListener("click", function() {
    ...
    var docDefinition = {
      content: [
        ...
        { text: 'Reporte de Medicamentos', style: 'header', alignment: 'center' },
        { text: '\n' },
        ...
        { text: '\n' },
        {
          table: {
            headerRows: 1,
            widths: [15, 90, 45, 45,45,70,70,70],
            body: [
              [
                { text: 'ID', style: 'tableHeader', fillColor: '#C6C6C6' },
                { text: 'Nombre', style: 'tableHeader', fillColor: '#C6C6C6' },
                { text: 'Stock Actual', style: 'tableHeader', fillColor: '#C6C6C6' },
                { text: 'Stock Minimo', style: 'tableHeader', fillColor: '#C6C6C6' },
                { text: 'Stock Maximo', style: 'tableHeader', fillColor: '#C6C6C6' },
                { text: 'Costo de Compra', style: 'tableHeader', fillColor: '#C6C6C6' },
                { text: 'Precio de Venta', style: 'tableHeader', fillColor: '#C6C6C6' },
              ...
              ...datos.map(function(dato, index) {
                return [
                  ...
                  { text: dato.stockActual, fillColor: index % 2 === 0 ? '#E5E5E5' : '#D9D9D9',style:'name' },
                  { text: dato.stockMinimo, fillColor: index % 2 === 0 ? '#E5E5E5' : '#D9D9D9',style:'name' },
                  { text: dato.stockMaximo, fillColor: index % 2 === 0 ? '#E5E5E5' : '#D9D9D9',style:'name' },
                  { text: dato.costoCompra, fillColor: index % 2 === 0 ? '#E5E5E5' : '#D9D9D9',style:'name' },
                  { text: dato.precioVenta, fillColor: index % 2 === 0 ? '#E5E5E5' : '#D9D9D9',style:'name' },
                  { text: dato.fechaRegistro, fillColor: index % 2 === 0 ? '#E5E5E5' : '#D9D9D9',style:'name' }
                ];
              })
            ]
          }
