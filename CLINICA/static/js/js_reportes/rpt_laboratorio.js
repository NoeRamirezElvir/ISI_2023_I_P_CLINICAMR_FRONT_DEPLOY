  ...
  document.getElementById("exportBtn").addEventListener("click", function() {
    ...
    var docDefinition = {
      content: [
        ...
        { text: 'Reporte de Laboratorios', style: 'header', alignment: 'center' },
        { text: '\n' },
            ...
            body: [
              ...
              ...datos.map(function(dato, index) {
                return [
                  ...
                  { text: dato.disponibilidad === 1 ? 'Disponible':'No Disponible', fillColor: index % 2 === 0 ? '#E5E5E5' : '#D9D9D9',style:'name' },
