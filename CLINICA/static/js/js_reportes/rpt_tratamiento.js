  ...
  document.getElementById("exportarBtn").addEventListener("click", function() {
    ...
    var datosManipulados = listaDatos.map(function(dato) {
      return {
        ...
        Servicio: dato.idTipo.nombre,
        Precio: dato.idTipo.precio,
        TiempoImplementaciónDías: dato.diasTratamiento + " días",
        Estado: dato.estado
      };
    });
  ...
  document.getElementById("exportBtn").addEventListener("click", function() {
    ...
    var docDefinition = {
      content: [
        ...
        { text: 'Reporte de Tratamientos', style: 'header', alignment: 'center' },
        { text: '\n' },
          ...
          table: {
            ...
            body: [
              [
                ...
                { text: 'Tiempo de Implementación', style: 'tableHeader', fillColor: '#C6C6C6' },
              ...
              ...datos.map(function(dato, index) {
                return [
                  ...
                  { text: dato.diasTratamiento + " días", fillColor: index % 2 === 0 ? '#E5E5E5' : '#D9D9D9',style:'name' },
                  { text: dato.estado, fillColor: index % 2 === 0 ? '#E5E5E5' : '#D9D9D9',style:'name' }
                ];
              })
            ]
          }
