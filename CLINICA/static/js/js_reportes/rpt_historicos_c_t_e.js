...
document.getElementById("exportarBtn").addEventListener("click", function() {
    ...
    var datosHiddenTitulo = document.getElementById("datosHiddenTitulo").value;
...
var docDefinition = {
    ...
    { text: 'Reporte de ' + datosHiddenTitulo, style: 'header', alignment: 'center' },
    { text: '\n' },
