...
function corregirDatosHidden() {
  ...
  document.getElementById("exportarBtn").addEventListener("click", function() {
    ...
    var datosManipulados = listaDatos.map(function(dato) {
        ...
        if (dato.idEnfermedades) {
          for (var clave in dato.idEnfermedades) {
            if (dato.idEnfermedades.hasOwnProperty(clave)) {
              enfermedadNombre += dato.idEnfermedades[clave].nombre + ', ';
            }
          }
  ...
  document.getElementById("exportBtn").addEventListener("click", function() {
    ...
    var docDefinition = {
      content: [
        ...
        { text: 'Reporte de Diagnosticos', style: 'header', alignment: 'center' },
        { text: '\n' },
          ...
          table: {
            ...
            body: [
              [
                ...
                { text: 'Descripción', style: 'tableHeader', fillColor: '#C6C6C6' },
              ...
              ...datosManipulados.map(function(dato, index) {
                return [
                  ...
                  { text: dato.Descripcion, fillColor: index % 2 === 0 ? '#E5E5E5' : '#D9D9D9', style: 'name' },
